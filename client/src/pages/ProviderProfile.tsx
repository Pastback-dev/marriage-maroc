...
const SERVICE_CATEGORIES = [
  { id: "traiteur", name: "Catering", icon: Utensils, bg: "bg-orange-50" },
  { id: "hall", name: "Wedding Venues", icon: HomeIcon, bg: "bg-blue-50" },
  { id: "dj", name: "DJ & Live Orchestra", icon: Music, bg: "bg-purple-50" },
  { id: "cameraman", name: "Photography", icon: Camera, bg: "bg-rose-50" },
  { id: "neggafa", name: "Bridal Makeup", icon: UserRound, bg: "bg-amber-50" },
  { id: "decoration", name: "Decor", icon: Paintbrush, bg: "bg-emerald-50" },
];
    ...
    <div className="min-h-screen bg-background">
      ...
      <div className="container mx-auto px-4 py-8 max-w-6xl">
        <div className="mb-8">
          ...
          <h1 className="text-3xl font-display font-bold text-secondary">{provider.displayName || provider.username}</h1>
        ...
        <div className="grid lg:grid-cols-3 gap-8">
            ...
            <Card className="border-primary/20 shadow-sm">
              ...
              <CardContent>
                <p className="text-muted-foreground whitespace-pre-wrap leading-relaxed">
                  {provider.description || "No description provided yet. This professional is dedicated to making your Moroccan wedding dreams come true."}
                </p>
              </CardContent>
            </Card>

            {/* Portfolio Gallery - Matching Dashboard Style */}
          ...
          <div className="space-y-6">
            <Card className="border-primary/20 shadow-sm sticky top-24">
              <CardHeader>
                <CardTitle className="text-lg font-display text-secondary">Contact Vendor</CardTitle>
              </CardHeader>
              <CardContent className="space-y-6">
                ...
                <Button className="w-full bg-secondary hover:bg-secondary/90 text-white font-bold h-12 rounded-xl shadow-lg shadow-secondary/10">
